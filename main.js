const cards = [
    ...
    { id: 2, name: "Void Witch", description: "Une créature de pure énergie.", img: "./images/2.png", price: 25.50, rarity: "legendary" },
    { id: 3, name: "Spectre de Néon", description: "Une entitée insaisissable qui hante le réseau.", img: "./images/3.png", price: 40.50, rarity: "commun" },
    { id: 4, name: "Chimère des Étoiles", description: "Une fusion de bêtes imprévisible.", img: "./images/4.png", price: 50.00, rarity: "epic" },
    { id: 5, name: "Phénix Binaire", description: "Renaissant de ses cendres numériques.", img: "./images/5.png", price: 25.50, rarity: "legendary" },
    { id: 6, name: "Golem de Quantum", description: "Un colosse instable, capable de manipuler la réalité.", img: "./images/6.png", price: 14.50, rarity: "commun" },
